...
const EXPERIENCE: Experience[] = [
  ...
  },
  {
    ...
    technologies: [
      ...
      + ' <abbr rel="tooltip" data-title="Structured Query Languages">SQL</abbr>.',
  ...
  },
  {
    ...
    technologies: [
      ...
      'Provisioning, push deployment,'
      + ' <abbr rel="tooltip" data-title="Virtual Machine">VM</abbr> instantiation and isolation.',
  ...
  },
  {
    ...
    technologies: [
      ...
      'Typescript, Dart.',
      'Angular 2, Ionic 2.',
      '<abbr rel="tooltip" data-title="Node Package Manager">NPM</abbr>,'
      + ' Gulp,'
      + ' <abbr rel="tooltip" data-title="LEaner cSS">LESS</abbr>,'
      + ' <abbr rel="tooltip" data-title="Syntactically Awesome Style Sheets">SASS</abbr>.',
      ' <abbr rel="tooltip" data-title="REpresentational State Transfer">REST</abbr>,'
      + ' Spring Boot, '
      + ' <abbr rel="tooltip" data-title="Not Only SQL">NoSQL</abbr>.',
    ],
    organizations: [
      '<abbr rel="tooltip" data-title="via IntraNotions">Google<span class="small">*</span></abbr>',
